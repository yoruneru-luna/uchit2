...
@php
    ...
    $hasProgress = $fading + $learned + $process + $new > 0;
@endphp
...
<section {{ $attributes->merge(['class' => 'progress-card shadow']) }} data-home-progress-summary>
    ...
    <div class="progress-card__bar {{ !$hasProgress ? 'is-empty' : '' }}" data-progress-bar>
        @if ($hasProgress)
            ...
            <span class="progress-card__segment progress-card__segment--learned" style="width: {{ $learned }}%;"
                ...
                <span class="progress-card__legend-item progress-card__legend-item--learned"
                    data-home-progress-learned-text data-home-progress-value>
                    {{ $learned }}% закреплено
                </span>
            </span>
            ...
            <span class="progress-card__segment progress-card__segment--new" style="width: {{ $new }}%;"
                ...
                <span
                    class="progress-card__legend-item progress-card__legend-item--new progress-card__legend-item--right"
